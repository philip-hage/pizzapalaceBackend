...
<div class="margin-bottom-md">
    <div class="flex flex-wrap gap-sm items-center justify-between">
        <a class="btn btn--primary" href="<?= URLROOT ?>Vehicle/create">+ New Vehicle</a>
    </div>
</div>
                ...
                <tbody class="int-table__body js-int-table__body">
                    <?php foreach ($data['vehicles'] as $vehicle) : ?>
                        <tr class="int-table__row">
                            ...
                            <td class="int-table__cell"><a href="<?= URLROOT ?>Vehicle/update/<?= $vehicle->vehicleId ?>">Edit</a></td>
                            <td class="int-table__cell"><a href="<?= URLROOT ?>Vehicle/delete/<?= $vehicle->vehicleId ?>">Delete</a></td>
                            <td class="int-table__cell">
        ...
        <nav class="pagination text-sm" aria-label="Pagination">
            <ul class="pagination__list flex flex-wrap gap-xxxs">
                <li>
                    ...
                    $prevPageLink = URLROOT . "Vehicle/overview/?page=$prevPage";
                ...
                <li>
                    ...
                    $nextPageLink = URLROOT . "Vehicle/overview/?page=$nextPage";
