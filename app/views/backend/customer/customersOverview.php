    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        ...
        <div class="margin-bottom-md">
            <div class="flex flex-wrap gap-sm items-center justify-between">
                ...
                <a class="btn btn--primary" href="<?= URLROOT ?>PizzaController/createCustomer">+ New User</a>
            </div>
        </div>
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            <?php foreach ($data['customers'] as $customer) : ?>
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell"><?= $customer->customerId ?></td>
                                    <td class="int-table__cell"><?= $customer->customerFirstName . " " . $customer->customerLastName ?></td>
                                    <td class="int-table__cell"><?= $customer->customerEmail ?></td>
                                    <td class="int-table__cell text-truncate max-width-xxxxs"><?= $customer->customerPhone ?></td>
                                    ...
                                    <td class="int-table__cell"><a href="<?= URLROOT ?>PizzaController/editCustomer/<?= $customer->customerId ?>">Edit</a></td>
                                    <td class="int-table__cell"><a href="<?= URLROOT ?>PizzaController/deleteCustomer/<?= $customer->customerId ?>">Delete</a></td>
                                    <td class="int-table__cell">
...
<div class="modal modal--animate-translate-up flex flex-center bg-black bg-opacity-90% padding-md js-modal" id="modal-new-customer">
    <div class="modal__content width-100% max-width-xs bg radius-md shadow-md" role="alertdialog" aria-labelledby="modal-title">
        ...
        <div class="padding-md">
            <form action="<?= URLROOT; ?>pizzacontroller/createCustomer" method="post">
                <div class="grid gap-sm">
                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-customer-firstname">FirstName</label>
                        <input class="form-control width-100%" type="text" name="customerfirstname" id="modal-customer-firstname" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-customer-lastname">LastName</label>
                        <input class="form-control width-100%" type="text" name="customerlastname" id="modal-customer-lastname" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-customer-streetname">StreetName</label>
                        <input class="form-control width-100%" type="text" name="customerstreetname" id="modal-customer-streetname" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-customer-zipcode">Zipcode</label>
                        <input class="form-control width-100%" type="text" name="customerzipcode" id="modal-customer-zipcode" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-customer-city">City</label>
                        <input class="form-control width-100%" type="text" name="customercity" id="modal-customer-city" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-customer-email">Email</label>
                        <input class="form-control width-100%" type="email" name="customeremail" id="modal-customer-email" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-customer-phone">Phone Number</label>
                        <input class="form-control width-100%" type="number" name="customerphone" id="modal-customer-phone" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-customer-type">Customer Type</label>
