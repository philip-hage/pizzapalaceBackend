...
<div class="app-ui js-app-ui">
                ...
                <nav class="sidenav padding-y-sm js-sidenav">
                    ...
                    <ul class="sidenav__list">
                        ...
                        <li class="sidenav__item sidenav__item--expanded">
                            ...
                            <ul class="sidenav__list">
                                <li class="sidenav__item">
                                    <a href="<?= URLROOT; ?>PizzaController/customersOverview" class="sidenav__link">
                                        <span class="sidenav__text text-sm@md">Customers</span>
                                    </a>
                                </li>

                                <li class="sidenav__item">
                                    <a href="<?= URLROOT; ?>PizzaController/ordersOverview" class="sidenav__link">
                                        <span class="sidenav__text text-sm@md">Orders</span>
                                    </a>
                                </li>

                                <li class="sidenav__item">
                                    <a href="<?= URLROOT; ?>PizzaController/ingredientsOverview" class="sidenav__link">
                                        <span class="sidenav__text text-sm@md">Ingredients</span>
                                    </a>
                                </li>

                                <li class="sidenav__item">
                                    <a href="<?= URLROOT; ?>PizzaController/employeesOverview" class="sidenav__link">
                                        <span class="sidenav__text text-sm@md">Employees</span>
                                    </a>
                                </li>

                                <li class="sidenav__item">
                                    <a href="<?= URLROOT; ?>PizzaController/reviewsOverview" class="sidenav__link">
                                        <span class="sidenav__text text-sm@md">Reviews</span>
                                    </a>
                                </li>

                                <li class="sidenav__item">
                                    <a href="<?= URLROOT; ?>PizzaController/storesOverview" class="sidenav__link">
                                        <span class="sidenav__text text-sm@md">Stores</span>
                                    </a>
                                </li>

                                <li class="sidenav__item">
                                    <a href="<?= URLROOT; ?>PizzaController/vehiclesOverview" class="sidenav__link">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        ...
        <div class="margin-bottom-md">
            ...
            <a class="btn btn--primary" href="<?= URLROOT ?>PizzaController/createEmployee">+ New Employee</a>
            </div>
        </div>
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            <?php foreach ($data['employees'] as $employee) : ?>
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell"><a href="<?= URLROOT ?>PizzaController/editEmployee/<?= $employee->employeeId ?>">Edit</a></td>
                                    <td class="int-table__cell"><a href="<?= URLROOT ?>PizzaController/deleteEmployee/<?= $employee->employeeId ?>">Delete</a></td>
                                    <td class="int-table__cell">
...
<!-- modal window -->
<div class="modal modal--animate-translate-up flex flex-center bg-black bg-opacity-90% padding-md js-modal" id="modal-new-employee">
    <div class="modal__content width-100% max-width-xs bg radius-md shadow-md" role="alertdialog" aria-labelledby="modal-title">
        ...
        <div class="padding-md">
            <form action="<?= URLROOT; ?>pizzacontroller/createEmployee" method="post">
                <div class="grid gap-sm">
                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-employee-firstname">FirstName</label>
                        <input class="form-control width-100%" type="text" name="employeeFirstName" id="modal-employee-firstname" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-employee-lastname">LastName</label>
                        <input class="form-control width-100%" type="text" name="employeeLastName" id="modal-employee-lastname" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-employee-streetname">StreetName</label>
                        <input class="form-control width-100%" type="text" name="employeeStreetName" id="modal-employee-streetname" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-employee-zipcode">Zipcode</label>
                        <input class="form-control width-100%" type="text" name="employeeZipCode" id="modal-employee-zipcode" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-employee-city">City</label>
                        <input class="form-control width-100%" type="text" name="employeeCity" id="modal-employee-city" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-employee-email">Email</label>
                        <input class="form-control width-100%" type="email" name="employeeEmail" id="modal-employee-email" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-employee-phone">Phone Number</label>
                        <input class="form-control width-100%" type="number" name="employeePhone" id="modal-employee-phone" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-employee-type">Employee Role</label>
                        <select class="form-control width-100%" name="employeeRole" id="modal-employee-type" required>
