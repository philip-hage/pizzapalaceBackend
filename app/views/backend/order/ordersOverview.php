    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        ...
        <div class="margin-bottom-md">
            <div class="flex flex-wrap gap-sm items-center justify-between">
                <button class="btn btn--primary" aria-controls="modal-new-customer">+ New Order</button>
            </div>
        </div>
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            <?php foreach ($data['orders'] as $order) : ?>
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell"><?= $order->orderId ?></td>
                                    <td class="int-table__cell"><?= $order->storeName ?></td>
                                    <td class="int-table__cell"><?= $order->customerFirstName . " " . $order->customerLastName ?></td>
                                    ...
                                    <td class="int-table__cell"><a href="<?= URLROOT; ?>pizzacontroller/orderHasProducts/<?= $order->orderId ?>">Read</a></td>
                                    <td class="int-table__cell">Edit</td>
                                    <td class="int-table__cell">Delete</td>
                                    <td class="int-table__cell">
