...
<div class="margin-bottom-md">
    <div class="flex flex-wrap gap-sm items-center justify-between">
        <a class="btn btn--primary" href="<?= URLROOT ?>Order/create">+ New Order</a>
    </div>
</div>
                ...
                <tbody class="int-table__body js-int-table__body">
                    <?php foreach ($data['orders'] as $order) : ?>
                        <tr class="int-table__row">
                            ...
                            <td class="int-table__cell"><a href="<?= URLROOT; ?>Order/orderHasProducts/<?= $order->orderId ?>">Read</a></td>
                            <td class="int-table__cell"><a href="<?= URLROOT ?>Order/update/<?= $order->orderId ?>">Edit</a></td>
                            <td class="int-table__cell">
        ...
        <nav class="pagination text-sm" aria-label="Pagination">
            <ul class="pagination__list flex flex-wrap gap-xxxs">
                <li>
                    ...
                    $prevPageLink = URLROOT . "Order/overview/?page=$prevPage";
                ...
                <li>
                    ...
                    $nextPageLink = URLROOT . "Order/overview/?page=$nextPage";
