...
<div class="app-ui js-app-ui">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        ...
        <div class="margin-bottom-md">
            ...
            <a class="btn btn--primary" href="<?= URLROOT ?>PizzaController/createProduct">+ New Product</a>
            </div>
        </div>
                    ...
                    <table class="int-table__table" aria-label="Interactive table example">
                        <thead class="int-table__header js-int-table__header">
                            <tr class="int-table__row">
                                ...
                                <th class="int-table__cell int-table__cell--th text-left">Price</th>
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            <?php foreach ($data['products'] as $product) : ?>
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell"><?= $product->productId ?></td>
                                    <td class="int-table__cell"><?= $product->productName ?></td>
                                    <td class="int-table__cell"><?= $product->customerFirstname ?></td>
                                    ...
                                    <td class="int-table__cell"><a href="<?= URLROOT ?>PizzaController/productEdit/<?= $product->productId ?>">Edit</a></td>
                                    <td class="int-table__cell"><a href="<?= URLROOT ?>PizzaController/deleteProduct/<?= $product->productId ?>">Delete</a></td>
                                    <td class="int-table__cell">
            ...
            <form>
                <div class="grid gap-sm">
                    <div class="col-12">
                        ...
                        <input class="form-control width-100%" type="text" name="modal-customer-name" id="modal-customer-name" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-customer-email">Email</label>
                        <input class="form-control width-100%" type="email" name="modal-customer-email" id="modal-customer-email" required>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="flex flex-wrap gap-sm">
                            <li>
                                <input class="radio" type="radio" name="modal-customer-status" id="modal-customer-status-free" checked>
                                <label for="modal-customer-status-free">Free</label>
                            </li>

                            <li>
                                <input class="radio" type="radio" name="modal-customer-status" id="modal-customer-status-pro">
