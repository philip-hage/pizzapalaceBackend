    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        ...
        <div class="margin-bottom-md">
            <div class="flex flex-wrap gap-sm items-center justify-between">
                <a class="btn btn--primary" href="<?= URLROOT ?>PizzaController/createIngredient">+ New Ingredient</a>
            </div>
        </div>
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            <?php foreach ($data['ingredients'] as $ingredient) : ?>
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell"><a href="<?= URLROOT ?>PizzaController/editIngredient/<?= $ingredient->ingredientId ?>">Edit</a></td>
                                    <td class="int-table__cell"><a href="<?= URLROOT ?>PizzaController/deleteIngredient/<?= $ingredient->ingredientId ?>">Delete</a></td>
                                    <td class="int-table__cell">
...
<!-- modal window -->
<div class="modal modal--animate-translate-up flex flex-center bg-black bg-opacity-90% padding-md js-modal" id="modal-new-ingredient">
    <div class="modal__content width-100% max-width-xs bg radius-md shadow-md" role="alertdialog" aria-labelledby="modal-title">
        ...
        <div class="padding-md">
            <form action="<?= URLROOT; ?>pizzacontroller/createIngredient" method="post">
                <div class="grid gap-sm">
                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-ingredient-firstname">Name </label>
                        <input class="form-control width-100%" type="text" name="ingredientName" id="modal-ingredient-firstname" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-ingredient-lastname">Price</label>
                        <input class="form-control width-100%" type="text" name="ingredientPrice" id="modal-ingredient-lastname" required>
                    </div>
