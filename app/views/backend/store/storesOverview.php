...
<div class="app-ui js-app-ui">
    ...
    <main class="app-ui__body padding-md js-app-ui__body">
        <div class="margin-bottom-md">
            <h1 class="text-lg">Stores</h1>
        </div>

        <div class="margin-bottom-md">
            <div class="flex flex-wrap gap-sm items-center justify-between">
                <a class="btn btn--primary" href="<?= URLROOT ?>PizzaController/createStore">+ New Store</a>
                        ...
                        <tbody class="int-table__body js-int-table__body">
                            <?php foreach ($data['stores'] as $store) : ?>
                                <tr class="int-table__row">
                                    ...
                                    <td class="int-table__cell"><?= $store->storeId ?></td>
                                    <td class="int-table__cell"><?= $store->storeName ?></td>
                                    <td class="int-table__cell"><?= $store->storeEmail ?></td>
                                    <td class="int-table__cell text-truncate max-width-xxxxs"><?= $store->storePhone ?></td>
                                    <td class="int-table__cell"><?= date('d/m/Y', $store->storeCreateDate) ?></td>
                                    <td class="int-table__cell"><?= $store->storeCity ?></td>
                                    <td class="int-table__cell"><a href="<?= URLROOT; ?>pizzacontroller/storeHasEmployees/<?= $store->storeId ?>">Employees</a></td>
                                    <td class="int-table__cell"><a href="<?= URLROOT; ?>pizzacontroller/storeHasVehicles/<?= $store->storeId ?>">Vehicles</a></td>
                                    <td class="int-table__cell"><a href="<?= URLROOT ?>PizzaController/editStore/<?= $store->storeId ?>">Edit</a></td>
                                    <td class="int-table__cell"><a href="<?= URLROOT ?>PizzaController/deleteStore/<?= $store->storeId ?>">Delete</a></td>
                                    <td class="int-table__cell">
...
<!-- modal window -->
<div class="modal modal--animate-translate-up flex flex-center bg-black bg-opacity-90% padding-md js-modal" id="modal-new-store">
    <div class="modal__content width-100% max-width-xs bg radius-md shadow-md" role="alertdialog" aria-labelledby="modal-title">
        ...
        <div class="padding-md">
            <form action="<?= URLROOT; ?>pizzacontroller/createStore" method="post">
                <div class="grid gap-sm">
                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-store-storeName">Name </label>
                        <input class="form-control width-100%" type="text" name="storeName" id="modal-store-storeName" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-store-storeZipcode">ZipCode</label>
                        <input class="form-control width-100%" type="text" name="storeZipcode" id="modal-store-storeZipcode" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-store-storeStreetName">StreetName</label>
                        <input class="form-control width-100%" type="text" name="storeStreetName" id="modal-store-storeStreetName" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-store-storeCity">City</label>
                        <input class="form-control width-100%" type="text" name="storeCity" id="modal-store-storeCity" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-store-storePhone">Phone Number</label>
                        <input class="form-control width-100%" type="number" name="storePhone" id="modal-store-storePhone" required>
                    </div>

                    <div class="col-12">
                        <label class="form-label margin-bottom-xxs" for="modal-store-storeEmail">Email</label>
                        <input class="form-control width-100%" type="email" name="storeEmail" id="modal-store-storeEmail" required>
                    </div>
