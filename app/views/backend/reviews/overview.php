                ...
                <tbody class="int-table__body js-int-table__body">
                    <?php foreach ($data['reviews'] as $review) : ?>
                        <tr class="int-table__row">
                            ...
                            <td class="int-table__cell"><a href="<?= URLROOT ?>Review/update/<?= $review->reviewId ?>">Edit</a></td>
                            <td class="int-table__cell"><a href="<?= URLROOT ?>Review/delete/<?= $review->reviewId ?>">Delete</a></td>
                            <td class="int-table__cell">
