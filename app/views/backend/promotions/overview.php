...
<div class="margin-bottom-md">
    <div class="flex flex-wrap gap-sm items-center justify-between">
        ...
        <a class="btn btn--primary" href="<?= URLROOT ?>Promotion/create">+ New Promotion</a>
    </div>
</div>
                ...
                <tbody class="int-table__body js-int-table__body">
                    <?php foreach ($data['promotions'] as $promotion) : ?>
                        <tr class="int-table__row">
                            ...
                            <td class="int-table__cell"><a href="<?= URLROOT ?>Promotion/update/<?= $promotion->promotionId ?>">Edit</a></td>
                            <td class="int-table__cell"><a href="<?= URLROOT ?>Promotion/delete/<?= $promotion->promotionId ?>">Delete</a></td>
                            <td class="int-table__cell">
